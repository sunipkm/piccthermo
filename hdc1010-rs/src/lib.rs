...
pub use core::{AcquisitionMode, Both, Hdc1010, Hdc1010Builder, Separate};
pub use error::Error;
pub use register::{
    AcquisitionModeEnum, Humidity, HumidityResolution, Temperature, TemperatureResolution, Trigger,
};
